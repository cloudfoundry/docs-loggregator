...
This repository contains documentation for the Loggregator component of Cloud Foundry. Loggregator is the logging and metrics subsystem that aggregates and streams logs and metrics from Cloud Foundry components and applications.

This is a content repository in the [Cloud Foundry documentation set](https://github.com/cloudfoundry/docs-book-cloudfoundry).

## Published location

This content is published at https://docs.cloudfoundry.org/loggregator/.
